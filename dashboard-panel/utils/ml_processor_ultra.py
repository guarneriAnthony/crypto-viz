...
class CryptoMLProcessorUltra:
    ...
    def websocket_handler(self, websocket, path):
        ...
        try:
            # await websocket.wait_closed() # WebSocket désactivé
        finally:
    ...
    def broadcast_alert(self, alert_data):
        ...
        """Diffuse une alerte (WebSocket désactivé temporairement)"""
    ...
    def calculate_advanced_predictions(self, symbol: str) -> Optional[Dict]:
        ...
        try:
            ...
            # Alertes désactivées temporairement - TODO: Fix async
    ...
    def _check_and_send_alerts(self, predictions: Dict):
        ...
        # Envoyer les alertes
        for alert in alerts:
            # await self.broadcast_alert(alert) # Désactivé temporairement
    ...
    def process_message_async_disabled(self, message):
    ...
    def run(self):
        ...
        try:
            ...
            for message in self.consumer:
                # Traitement synchrone (compatible avec Streamlit)
...
if __name__ == "__main__":
    ...
    processor.run()# Fix broadcast_alert function: 1757364563
